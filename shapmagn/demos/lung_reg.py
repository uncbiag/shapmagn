...
model_opt =ParameterDict()
model_opt["debugging_visualize"] = True
model_opt["saving_debugging_visualize"] = True
...
kernel_size = 0.12 # iso 0.08
spline_param="cov_sigma_scale=0.02,aniso_kernel_scale={},principle_weight=(3.,1.,1.),eigenvalue_min=0.1,iter_twice=True".format(kernel_size)
...
model_opt["gradflow_guided"] ['pair_shape_transformer_obj']="lung_data_analysis.pair_shape_transformer( init_thres= 3.0e-5, nstep=8)"
model_opt["gradflow_guided"] [("geomloss", {}, "settings for geomloss")]
