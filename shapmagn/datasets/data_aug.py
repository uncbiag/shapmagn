...
from shapmagn.shape.point_sampler import point_uniform_sampler, point_grid_sampler,uniform_sampler
...
class SplineAug(object):
    ...
    def __init__(self,aug_settings):
        ...
        local_deform_spline_kernel_obj = local_deform_aug_settings[("local_deform_spline_kernel_obj","","sampling spline kernel object")]
