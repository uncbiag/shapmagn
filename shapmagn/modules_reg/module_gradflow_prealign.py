...
class GradFlowPreAlign(nn.Module):
    def __init__(self, opt):
        ...
        self.eval_scale_for_rigid = opt[("eval_scale_for_rigid",True,"evaluate scale for the rigid transformation")]
    ...
    def solve_rigid(self,x,y,w):
        ...
        s= (tr_atr/tr_xtwx)[...,None][...,None] if self.eval_scale_for_rigid else 1.
