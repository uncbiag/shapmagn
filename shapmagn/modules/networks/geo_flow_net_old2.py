...
class GeoFlowNet(nn.Module):
    ...
    def forward(self,pc1, pc2, feature1, feature2):
        ...
        l0_fea1 = self.channel_conv0_2(self.spatial_conv0(l0_pc1,l0_pc1,l0_fea1 ))+l0_fea1
        l0_fea1 = self.channel_conv0_3(l0_fea1)
        l0_fea2 = self.channel_conv0_1(self.channel_conv0_0(feature2))
        l0_fea2 = self.channel_conv0_2(self.spatial_conv0(l0_pc2, l0_pc2, l0_fea2))+l0_fea2
        ...
        l1_fea1 = self.channel_conv1_2(self.spatial_conv1_1(l1_pc1,l1_pc1,l1_fea1)) +l1_fea1
        ...
        l1_fea2 = self.channel_conv1_2(self.spatial_conv1_1(l1_pc2, l1_pc2, l1_fea2))+l1_fea2
