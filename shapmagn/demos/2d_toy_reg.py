...
source_path =  server_path+"data/toy_demo_data/tree_2d_source3.png"  #tree_2d_source3 tree_2d_source3_3
...
model_opt["gradflow_guided"]["geomloss"]["geom_obj"] = "geomloss.SamplesLoss(loss='sinkhorn',blur=blurplaceholder, reach=0.1,scaling=0.8,debias=False)"
model_opt["gradflow_guided"]["post_kernel_obj"]= model_opt["spline_kernel_obj"]
