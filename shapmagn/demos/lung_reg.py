...
# fixed_feature = True
# get_anistropic_gamma_obj = "'local_feature_extractor.compute_anisotropic_gamma_from_points(cov_sigma_scale=0.02,aniso_kernel_scale={},principle_weight=None,eigenvalue_min=0.1,iter_twice=True)'".format(feature_kernel_size)
# # model_opt["pair_feature_extractor_obj"] ="lung_feature_extractor.LungFeatureExtractor(fea_type_list=['eigenvalue_prod'],weight_list=[0.5], radius=0.03,get_anistropic_gamma_obj={},std_normalize=True, include_pos=True, fixed={})".\
# #     format(get_anistropic_gamma_obj,fixed_feature)
...
# model_opt["gradflow_guided"] ['pair_shape_transformer_obj']="lung_data_analysis.pair_shape_transformer( init_thres= 3.0e-5, nstep=10)"
# model_opt["gradflow_guided"] [("geomloss", {}, "settings for geomloss")]
