...
output_path = '/playpen-raid1/zyshen/debug/llf_preprocess_resol_256'
os.makedirs(output_path, exist_ok=True)

for i in range(12):

    file_name = "preprocess_resol_256_{}.sh".format(i)
    txt = """#!/bin/bash
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=8
#SBATCH --time=4-0
#SBATCH --mem=32G
#SBATCH --output=preprocess_resol_256_{}.txt
...
cd /pine/scr/z/y/zyshen/videocue/video_cue/preprocess
python preprocess_dfdc.py -d /pine/scr/z/y/zyshen/data/dfdc -op /pine/scr/z/y/zyshen/data/dfdc/processed -ot /pine/scr/z/y/zyshen/expri/dfdc/resol_256  -sv {}
    """.format(i,i)
