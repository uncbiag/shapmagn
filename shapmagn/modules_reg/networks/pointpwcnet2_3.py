...
class PointConvSceneFlowPWC2_3(nn.Module):
    def __init__(self, input_channel=3, initial_input_radius=1.,initial_input_npoints=40000,first_sampling_npoints=2048,predict_at_low_resl=False, param_shrink_factor=1):
        ...
        self.flow0 = SceneFlowEstimatorPointConv(sbf(32 + 64), sbf(32),channels = sbf([128, 128]), mlp = sbf([128, 64]))
        ...
        self.flow1 = SceneFlowEstimatorPointConv(sbf(64 + 64), sbf(64),channels = sbf([128, 128]), mlp = sbf([128, 64]))
        ...
        self.flow2 = SceneFlowEstimatorPointConv(sbf(128 + 64), sbf(128),channels = sbf([128, 128]), mlp = sbf([128, 64]))
        ...
        self.flow3 = SceneFlowEstimatorPointConv(sbf(256), sbf(256), flow_ch=0,channels = sbf([128, 128]), mlp = sbf([128, 64]))
