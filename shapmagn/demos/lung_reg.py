...
normalizer_obj = "lung_dataloader_utils.lung_normalizer(weight_scale=30000,scale=[100,100,100])"
sampler_obj = "lung_dataloader_utils.lung_sampler( method='combined',scale=0.0003,num_sample=60000,sampled_by_weight=True)"
...
spline_param="cov_sigma_scale=0.02,aniso_kernel_scale={},eigenvalue_min=0.2,iter_twice=True".format(kernel_size)
...
model_opt["pair_feature_extractor_obj"] ="lung_feature_extractor.LungFeatureExtractor(fea_type_list=['eigenvalue_prod'],weight_list=[0.2], radius=0.03,get_anistropic_gamma_obj={},std_normalize=True, include_pos=True, fixed={})".\
...
model_opt["gradflow_guided"] ['update_gradflow_reach_by_raito']= 0.8
model_opt["gradflow_guided"] ['gradflow_reach_min']= 1.0
model_opt["gradflow_guided"] ['pair_shape_transformer_obj']="lung_data_analysis.pair_shape_transformer( init_thres= 4.0e-5, nstep=8)"
model_opt["gradflow_guided"] [("geomloss", {}, "settings for geomloss")]
model_opt["gradflow_guided"]["geomloss"]["attr"] = "points" #todo  the pointfea will be  more generalized choice
model_opt["gradflow_guided"]["geomloss"]["geom_obj"] = "geomloss.SamplesLoss(loss='sinkhorn',blur=blurplaceholder, scaling=0.8,reach=reachplaceholder,debias=False, backend='online')"
model_opt["gradflow_guided"] ['post_kernel_obj']="point_interpolator.NadWatAnisoSpline(exp_order=2, cov_sigma_scale=0.02,aniso_kernel_scale=0.1,eigenvalue_min=0.2,iter_twice=True, fixed=False, leaf_decay=False, is_interp=True, self_center=False)"
...
blur = 0.001
model_opt['sim_loss']['geomloss']["geom_obj"] = "geomloss.SamplesLoss(loss='sinkhorn',blur={}, scaling=0.8,reach=1.0, debias=False, backend='online')".format(blur)
