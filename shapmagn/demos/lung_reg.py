...
def analysis(shape_pair, fea_to_map, mapped_fea, compute_on_half_lung=True):
...
# # model_opt["feature_extractor_obj"] ="lung_fea_extract.feature_extractor(fea_type_list=['eignvalue_prod'],weight_list=[0.1], radius=0.05,include_pos=True)"
#
# blur = 0.05
...
# solver_opt["save_every_n_iter"] = 5
# solver_opt["shape_sampler_type"] = "point_grid"
# solver_opt["stragtegy"] = "use_optimizer_defined_here"
# solver_opt[("optim", {}, "setting for the optimizer")]
# solver_opt[("scheduler", {}, "setting for the scheduler")]
...
model_opt["interpolator_obj"] ="point_interpolator.kernel_interpolator(scale=0.01, exp_order=2)"
model_opt["smooth_displacement"]= True
...
# blur = 0.0005
# feature_extractor_obj = "lung_fea_extract.feature_extractor(fea_type_list=['eignvalue_prod'],weight_list=[0.1], radius=0.01,include_pos=True)"
