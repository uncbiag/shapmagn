...
model_opt["gradflow_guided"]["geomloss"]["geom_obj"] = "geomloss.SamplesLoss(loss='sinkhorn',blur=blurplaceholder, scaling=0.8,debias=False, backend='online')"
...
mapped_fea = get_omt_mapping(model_opt['sim_loss']['geomloss'], source, target,fea_to_map ,p=2,mode="hard",confid=0.0)
visualize_multi_point([shape_pair.source.points[0],shape_pair.flowed.points[0],shape_pair.target.points[0]],
                     [fea_to_map,fea_to_map, mapped_fea],
                     ["source", "gradient_flow","target"],
                        [True, True, True],
