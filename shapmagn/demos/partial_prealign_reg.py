...
visualize_source_flowed_target_overlap(np.asarray(source.points),np.asarray(result.points),np.asarray(target.points),
                                       np.asarray(source.points),np.asarray(result.points),np.asarray(target.points),
                                               "CPD: source","prealigned","target",rgb_on=False,show=True,add_bg_contrast=False)
...
visualize_source_flowed_target_overlap(np.asarray(source.points),np.asarray(result.points),np.asarray(target.points),
                                       np.asarray(source.points),np.asarray(result.points),np.asarray(target.points),
                                               "Filterreg: source","prealigned","target",rgb_on=False,show=True,add_bg_contrast=False)
...
visualize_source_flowed_target_overlap(shape_pair.source.points,shape_pair.flowed.points,shape_pair.target.points,
                                       shape_pair.source.points,shape_pair.source.points,shape_pair.target.points,
                                               "OT: source","prealigned","target",rgb_on=False,show=True,add_bg_contrast=False)
