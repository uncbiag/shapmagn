...
source_path =  server_path+"data/toy_demo_data/tree_2d_source3.png"  #tree_2d_source3
target_path = server_path + "data/toy_demo_data/tree_2d_target4.png"
...
target_points, target_weights = get_points(target_path, npoint=1000)
