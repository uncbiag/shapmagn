...
# source_path = "/playpen-raid1/Data/UNC_vesselParticles/10005Q_EXP_STD_NJC_COPD_wholeLungVesselParticles.vtk"
# target_path = "/playpen-raid1/Data/UNC_vesselParticles/10005Q_INSP_STD_NJC_COPD_wholeLungVesselParticles.vtk"
source_path =  "/home/zyshen/remote/llr11_mount/Data/UNC_vesselParticles/10005Q_EXP_STD_NJC_COPD_wholeLungVesselParticles.vtk"
target_path = "/home/zyshen/remote/llr11_mount/Data/UNC_vesselParticles/10005Q_INSP_STD_NJC_COPD_wholeLungVesselParticles.vtk"
...
def get_omt_mapping(gemloss_setting, source, target, fea_to_map, blur=0.01, p=2,soft=True, confid=0.1):
    ...
    F_i, G_j  = gemoloss(weight1, attr1, weight2, attr2)
...
record_path = "/home/zyshen/remote/llr11_mount/zyshen/debug/gradient_lung_pair"
...
saving_gif_path = "/home/zyshen/remote/llr11_mount/zyshen/debug/gradient_lung_pair.gif"
fea_to_map =  shape_pair.source.points[0]
mapped_fea = get_omt_mapping(model_opt['sim_loss']['geomloss'], source, target,fea_to_map , blur= blur,p=2,soft=False,confid=0.1)
# visualize_point_pair(shape_pair.source.points[0],shape_pair.flowed.points[0],
#                      fea_to_map,fea_to_map,
#                      "source", "gradient_flow", saving_gif_path)
# visualize_point_pair(shape_pair.source.points[0],shape_pair.target.points[0],
#                      fea_to_map,maped_fea,
#                      "source", "gradient_flow", saving_gif_path)
...
# # experiment 2: lddmm flow
# solver_opt = ParameterDict()
# record_path = "/playpen-raid1/zyshen/debug/lddmm_lung_pair"
# solver_opt["record_path"] = record_path
# solver_opt["point_grid_scales"] =  [  -1]
# solver_opt["iter_per_scale"] = [200]
# solver_opt["rel_ftol_per_scale"] = [ 1e-9,1e-9,1e-9]
# solver_opt["init_lr_per_scale"] = [1,1e-4,1e-4]
