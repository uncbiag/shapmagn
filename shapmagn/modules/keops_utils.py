...
def AnisoKNN(cov_sigma_scale=0.02, aniso_kernel_scale=0.08,principle_weight=None, eigenvalue_min=0.3, iter_twice=True,leaf_decay=True, mass_thres=2.5, return_value=True):
