...
from shapmagn.modules_reg.networks.pointconv_util import PointConv, PointConvD, PointWarping3, UpsampleFlow3,PointWarping, UpsampleFlow, PointConvFlow, SceneFlowEstimatorPointConv2
...
class PointConvSceneFlowPWC2_5(nn.Module):
    ...
    def forward(self, xyz1, xyz2, color1, color2):
        ...
        feat2, resid_flow2, resid_fea_flow2 = self.flow2(pc1_l2, new_feat1_l2, cost2, up_flow2)
        ...
        feat1, resid_flow1 , resid_fea_flow1= self.flow1(pc1_l1, new_feat1_l1, cost1,
                                  up_flow1)
