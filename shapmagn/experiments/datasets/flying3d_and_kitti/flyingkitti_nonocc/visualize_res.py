...
camera_pos=[(12.24069705556629, 154.18144864069825, 52.5302855418096), (0.0, 0.0, 0.0), (0.17653893360765158, 0.08828369494012701, -0.9803264732365397)]
visualize_source_flowed_target_overlap(source.points,nonp.points, target.points, source.points, nonp.points, target.points, "source","nonp_gf","target",
                                       rgb_on=False, add_bg_contrast=True,camera_pos=camera_pos,saving_capture_path=None,show=True)
